...
public abstract class TImedMotor {
	/**
	 * Dans le cas d'un lancement du moteur pour un temps donné, vérifie si le
	 * temps est passé et que le moteur doit être arrêté
	 * 
	 * Vérifie si les moteurs sont coincés. Dans ce cas, les arrête. Par
	 * sécurité.
	 */
